  ...
  return (
    <Box>
      <SEO
        ...
        description="Elevate your online presence with Cojovi Digital Webworx's custom web development, app creation, and SEO services. A one-stop solution for digital marketing excellence."
      />
      <Box>
        <HeroSection />
